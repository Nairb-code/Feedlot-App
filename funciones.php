...
function HeadAboutUs(){
    echo `<a class="icon-link icon-link-hover" style="letter-spacing: 2px; transition: color 0.15s ease-in-out;" href="#"><font _mstmutation="1" _msttexthash="226915" _msthash="210"> Enlace de icono </font><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
